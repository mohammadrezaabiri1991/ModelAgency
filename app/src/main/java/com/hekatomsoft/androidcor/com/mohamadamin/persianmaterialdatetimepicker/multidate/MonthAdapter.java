...
import com.hekatomsoft.androidcor.com.mohamadamin.persianmaterialdatetimepicker.multidate.MonthView.OnDayClickListener;
...
public abstract class MonthAdapter extends BaseAdapter implements OnDayClickListener {
    ...
    public static class CalendarDay {
        ...
        public CalendarDay(PersianCalendar timeInMillis) {
            setTime(timeInMillis);
            year = timeInMillis.getPersianYear();
            month = timeInMillis.getPersianMonth();
            day = timeInMillis.getPersianDay();
        }

        private void setTime(PersianCalendar timeInMillis) {
        }
