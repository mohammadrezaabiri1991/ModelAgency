...
@InverseBindingMethods({
        @InverseBindingMethod(type = Integer.class, attribute = "selectedPosition"),
})
...
//            postInvalidateOnAnimation(); // TODO
    ...
    public static int getPosition(HorizontalPicker view) {
        view.selectedItem = view.getSelectedItem();
        return view.selectedItem;
    }

    @BindingAdapter("selectedPosition")
    public static void setCity(HorizontalPicker view, int selectedItem) {
        view.selectedItem = selectedItem;
//        if (view.entries != null) {
//            int selectedPosition = view.entries.indexOf(selectedItem);
            view.setSelectedItem(selectedItem);
//        }
    }

    @BindingAdapter("selectedPositionAttrChanged")
    public static void setProvinceListener(HorizontalPicker view, final InverseBindingListener positionChange) {
        if (positionChange == null) {
            view.setOnItemSelectedListener(null);
        } else {


            view.setOnItemSelectedListener(new OnItemSelected() {
                @Override
                public void onItemSelected(int index) {
